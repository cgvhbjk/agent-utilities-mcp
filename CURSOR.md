...
Hosted execution uses prepaid credits: individual calls cost $0.0003–$0.002 and funding starts with a $5 pack. The generic MCP adapter has no per-call ceiling beyond available credits; use the HTTP/Python clients for explicit price ceilings. It never buys credits, automatically tops up, or places merchant orders. Discovery alone spends nothing. Preserve returned request IDs and original arguments for ten-minute recovery; a new tool call is a new billable identity.
